...
#for (i in 2:30) {
#    area_oggm <- read.csv(dir_areas[i])
...
#        DF[year,,] <- df
#    }
#    save(DF, file=paste(dir_rcp45[i],"yearly_areas.rda",sep="/"))
...
#    save(perc, file=paste(dir_rcp45[i],"percentage_glacier_per_gridcell_area.rda",sep="/"))
#}

# Doing glacier melt daily file

#for (i in 2:30) {
#    melt_oggm <- read.csv(paste(dir_rcp45[i],"daily_melt.csv",sep="/"))
...
#    save(DFm, file=paste(dir_rcp45[i],"daily_melt_gridded.rda",sep="/"))

    # Doing daily rain file
#    rain_oggm <- read.csv(paste(dir_rcp45[i],"daily_rain.csv",sep="/"))
...
#    save(DFr, file=paste(dir_rcp45[i],"daily_rain_gridded.rda",sep="/"))
#}
