...
GRID_FILE = xr.open_dataset(".../mosart-input/rcp../.../mosart_new.nc")['area']
...
fut_qgm_85_df.to_csv(".../processed_flows/"+NBS+"/fut_qgm_85_df.csv")
fut_qtm_85_df.to_csv(".../processed_flows/"+NBS+"/fut_qtm_85_df.csv")
fut_qsm_85_df.to_csv(".../processed_flows/"+NBS+"fut_qsm_85_df.csv")
fut_qssm_85_df.to_csv(".../processed_flows/"+NBS+"fut_qssm_85_df.csv")
fut_qdm_85_df.to_csv(".../processed_flows/"+NBS+"fut_qdm_85_df.csv")

fut_qgm_45_df.to_csv(".../processed_flows/"+NBS+"/fut_qgm_45_df.csv")
fut_qtm_45_df.to_csv(".../processed_flows/"+NBS+"/fut_qtm_45_df.csv")
fut_qsm_45_df.to_csv(".../processed_flows/"+NBS+"/fut_qsm_45_df.csv")
fut_qssm_45_df.to_csv(".../processed_flows/"+NBS+"/fut_qssm_45_df.csv")
fut_qdm_45_df.to_csv(".../processed_flows/"+NBS+"/fut_qdm_45_df.csv")

hist_qgm_45_df.to_csv(".../processed_flows/"+NBS+"/hist_qgm_45_df.csv")
hist_qtm_45_df.to_csv(".../processed_flows/"+NBS+"/hist_qtm_45_df.csv")
hist_qsm_45_df.to_csv(".../processed_flows/"+NBS+"/hist_qsm_45_df.csv")
hist_qssm_45_df.to_csv(".../processed_flows/"+NBS+"/hist_qssm_45_df.csv")
hist_qdm_45_df.to_csv(".../processed_flows/"+NBS+"/hist_qdm_45_df.csv")
